...
Generate invoices of order forms in EenvoudigFactureren for WooCommerce orders.
...
1. Upload `woo-eenvoudigfactureren.zip` to the `/wp-content/plugins/` directory
